...
class BernSpider(scrapy.Spider):
    ...
    RESULT_PAGE_URL = 'http://www.zsg-entscheide.apps.be.ch/tribunapublikation/tribunavtplus/loadTable'
    ...
    HEADERS = { 'Content-type': 'text/x-gwt-rpc; charset=utf-8'
              ...
              , 'X-GWT-Module-Base': 'http://www.zsg-entscheide.apps.be.ch/tribunapublikation/tribunavtplus/'
              }
...
scraperwiki.sqlite.save(unique_keys=['Bern'], data={"Geschaeftsnummer": response.meta['number'], "format": "pdf", "file": response.body})
